<article class="b-content col-sm-9" id="jsConfig" data-street="<?= $arResult["ITEMS"][0]["PROPERTIES"]["ADDRESS"]["VALUE"]; ?>" data-coord='<?= $arResult["ITEMS"][0]["PROPERTIES"]["COORDINATE"]["VALUE"]; ?>'>
    <div class="b-content__wrap">
        ...
        <div class="article-head">
            <? if ( !empty($arResult["ITEMS"][0]["PROPERTIES"]["RATING"]["VALUE"]) ): ?>
                <div class="rating">
            ...
            <? endif; ?>
            <time class="article-date"><?= $arResult["ITEMS"][0]["DATE_FROM"][0]; ?> <?= \Francysk\Framework\Tools\Month::getMonth($arResult["ITEMS"][0]["DATE_FROM"][1], \Francysk\Framework\Tools\Month::P_ROD) ?> <?= $arResult["ITEMS"][0]["DATE_FROM"][2]?></time>
        </div>
        <p>
            ...
            <div class="slider">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <? foreach ( $arResult["ITEMS"][0]["PROPERTIES"]["MORE_PHOTO"]["VALUE"] as $id => $pid ):?>
        ...
        <? if ( !empty($arResult["ITEMS"][0]["PROPERTIES"]["PLUS"]["VALUE"]) || !empty($arResult["ITEMS"][0]["PROPERTIES"]["MINUS"]["VALUE"]) ): ?>
            <div class="options">
                <? if ( !empty($arResult["ITEMS"][0]["PROPERTIES"]["PLUS"]["VALUE"]) ): ?>
                ...
                <? endif; ?>
                <? if ( !empty($arResult["ITEMS"][0]["PROPERTIES"]["MINUS"]["VALUE"]) ): ?>
                    <ul class="options__list minus">
                        <? foreach ( $arResult["ITEMS"][0]["PROPERTIES"]["MINUS"]["VALUE"] as $text ): ?>
                            <li class="options__item"><?= $text; ?></li>
                        <? endforeach; ?>
                    </ul>
                <? endif; ?>
