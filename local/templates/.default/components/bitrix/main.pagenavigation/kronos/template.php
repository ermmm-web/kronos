...
?>
        ...
        <a class="catalog__next" href="<?=htmlspecialcharsbx($component->replaceUrlTemplate($arResult["CURRENT_PAGE"]+1))?>" title="<?=GetMessage("nav_next")?>">
            <div class="product-next">
                <div class="product-next__icon"></div>
                <div class="product-next__name"><?=GetMessage("nav_next")?></div>
            </div>
		</a>
