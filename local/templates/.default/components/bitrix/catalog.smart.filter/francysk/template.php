...
<div class="catalog__filter">
    	<div class="filter">		
            <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				...
				<div class="filters_wrapper">
					...
					foreach($arResult["ITEMS"] as $key=>$arItem)
					{
						...
						/* FIND NUMBER OF CHECKED ELEMENTS */
						$count = 0;
						...
						?>
						<div class="filter__item js-filter-root" id="filter__item-<?=$arItem["ID"]?>" >
							<div class="btn-wave filter__name js-filter-btn">
								<div class="btn-wave-container">                                                
									<? // \Francysk\Framework\View\Base::textHtmlEffect($arItem["NAME"]); ?> 
									<?=$arItem["NAME"] ?> 
									<span class="filter__count"><?=$count?></span>
								</div>
							</div>
							<div class="filter__drop">
								<div class="filter__drop-items">												
								<?
						...
						</div><!--filter__item--> <!-- onclick="smartFilter.click(this);" -->
					<?
					}				
				?></div><?
			...
			<div <?=$arResult["CHECKED_ITEMS"]?'':'style="display:none;"'?> class="selected_filter_wrapper">
				<div class="bx-filter-button-box">
					<div class="bx-filter-block">
						<div class="bx-filter-parameters-box-container">
							<div class="filter__selected_items">
								<div class="txt"><?=GetMessage("CT_BCSF_SELECTED_PARAM")?></div> 
								<ul>
							<?
								foreach ($arResult["CHECKED_ITEMS"] as $ar) {
									?><li><a href="javascript:void(0);" class="filter__selected_item" onClick="unset_filter_item('<?=$ar['CONTROL_ID']?>');" id="span_<?=$ar['CONTROL_ID']?>"><?=$ar['VALUE']?><span>x</span></a></li> <?
								}
