...
/* DELETE ? */
function calcMaxH(){
    //var wwin = $(window).prop("scrollWidth");

    $('.grid-main > div.banner-products__item').removeClass('banner-products__item_normal banner-products__item_mini');
    if (window.matchMedia('(max-width: 767.98px)').matches){

    }else if (window.matchMedia('(max-width: 959.98px)').matches){
        $('.grid-main > div:nth-of-type(1)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(2)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(3)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(4)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(5)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(6)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(7)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(8)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(9)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(10)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(11)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(12)').addClass('banner-products__item_normal');
        ...
        $('.grid-main > div:nth-of-type(11)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(12)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(13)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(14)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(15)').addClass('banner-products__item_normal');
    }else{
        $('.grid-main > div:nth-of-type(1)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(2)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(3)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(4)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(5)').addClass('banner-products__item_normal');
        $('.grid-main > div:nth-of-type(6)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(7)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(8)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(9)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(10)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(11)').addClass('banner-products__item_mini');
        $('.grid-main > div:nth-of-type(12)').addClass('banner-products__item_normal');
    }
}