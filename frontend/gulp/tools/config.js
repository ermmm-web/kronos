...
exports.tasks = [
  ...
  },
  {
    ...
    src: [
      path.join(src, "img/**/*.{jpeg,png,gif,jpg,bmp,svg}"),
      path.join("!", src, "img/sprite/*")
    ],
    build: path.join(build, "img")
  },
  {
    sort: 10,
    uses: true,
    ...
    src: path.join(src, "img/sprite/*.{jpeg,png,gif,jpg,bmp}"),
    build: path.join(build, "img"),
    style: path.join(src, "styles/sprite"),
    spritesmith: {
      //retinaSrcFilter: path.join(src, "img/sprite/*@2x.{jpeg,png,gif,jpg,bmp}")
    }
  },
  {
    sort: 10,
    ...
    src: path.join(src, "img/svg/**/*.svg"),
    build: path.join(build, "img/svg"),
    style: path.join(src, "styles/sprite"),
